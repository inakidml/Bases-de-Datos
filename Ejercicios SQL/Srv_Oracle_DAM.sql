...
*/
/* TRUCO PARA A�ADIR UN CONSTRAINT A UN NOT NULL EXISTENTE*/
...
ALTER TABLE EMPLEADO ADD CONSTRAINT EMP_APE_NN CHECK(COMISION IS NOT NULL);
...
FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'ALUMNOS';
    ...
    /*SI QUE HAY RESTRICCI�N TIPO NOT NULL, PERO SON DE TIPO CHECK*/
